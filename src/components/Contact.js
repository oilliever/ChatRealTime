...
import { Stack, Box, Typography, IconButton, Avatar, Divider, Button } from "@mui/material";
        ...
        <Box sx={{ width: 320, height: "100vh" }}>
            <Stack sx={{ height: "100%" }}>
                ...
                <Stack
                    ...
                    p={3}
                    spacing={3}>
                    <Stack alignItems={"cen"} direction="row" spacing={2}>
                        <Avatar
                    ...
                    <Stack direction={"row"} alignItems="center" justifyContent={"space-between"}>
                        <Stack direction={"row"} alignItems="center" spacing={2}>
                            <Bell size={21} />
                            <Typography variant="subtitle2">Mute Nofications</Typography>
                        </Stack>
                        <AntSwitch />
                    </Stack>
                    <Divider />
                    ...
                    <Stack direction={"row"} spacing={2} alignItems="center">
                        ...
                        <Stack spacing={0.5}>
                            <Typography variant="subtitle2">Cading Monk</Typography>
